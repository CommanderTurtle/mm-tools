...
export PYTHONPATH="$ROOT/..:$ROOT:$ROOT/../V2V${PYTHONPATH:+:$PYTHONPATH}"
...
export MM_STUDIO_HOST="${ANIMATE_STUDIO_HOST:-${MM_STUDIO_HOST:-127.0.0.1}}"
export MM_STUDIO_PORT="${ANIMATE_STUDIO_PORT:-${MM_STUDIO_PORT:-8264}}"
