...
Self-hosted installations can point directly at existing files with
``MUSCRIPTOR_SF2_PATH`` and ``MUSCRIPTOR_SF3_PATH``.  The published URLs stay
as a fallback for ordinary upstream installations.
"""
...
SF2_URL = os.environ.get(
    "MUSCRIPTOR_SF2_PATH", "hf://MuScriptor/assets/MuseScore_General.sf2"
)
...
SF3_URL = os.environ.get(
    "MUSCRIPTOR_SF3_PATH", "hf://MuScriptor/assets/MuseScore_General.sf3"
)
