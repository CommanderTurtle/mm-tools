...
import utils3d_moge.numpy, utils3d_moge.torch
...
- (ndarray): Sliding window of the input array.
    ...
    utils3d_moge.numpy.utils.sliding_window
...
## Returns
    ...
    utils3d_moge.numpy.utils.pooling
...
def max_pool_2d(x: numpy_.ndarray, kernel_size: Union[int, Tuple[int, int]], stride: Union[int, Tuple[int, int]], padding: Union[int, Tuple[int, int]], axis: Tuple[int, int] = (-2, -1)):
    utils3d_moge.numpy.utils.max_pool_2d
...
`O((Q + K) * log(Q + K))` complexity, where `Q` is the number of queries and `K` is the number of keys."""
    utils3d_moge.numpy.utils.lookup
...
## Returns
    ...
    utils3d_moge.numpy.utils.lookup_get
...
- `result_value (ndarray): shape `(N_new, *value_shape)` """
    utils3d_moge.numpy.utils.lookup_set
...
- `groups` `(List[Tuple[ndarray, ndarray]])`: List of each group, a tuple of `(label, data_in_group)`.
    ...
    utils3d_moge.numpy.utils.group
...
## Returns
    ...
    utils3d_moge.numpy.utils.csr_matrix_from_dense_indices
...
Equivalent to `np.argsort(perm, axis=axis)`, but more efficient."""
    utils3d_moge.numpy.utils.reverse_permutation
...
- `outer` (ndarray): shape `(..., M, N)` outer product of `x` and `y`."""
    utils3d_moge.numpy.utils.vector_outer
...
## Returns
    ...
    utils3d_moge.numpy.transforms.perspective_from_fov
...
## Returns
    (ndarray): [..., 4, 4] perspective matrix"""
    utils3d_moge.numpy.transforms.perspective_from_window
...
----
    ...
    utils3d_moge.numpy.transforms.intrinsics_from_fov
...
## Returns
    (ndarray): [..., 3, 3] OpenCV intrinsics matrix"""
    utils3d_moge.numpy.transforms.intrinsics_from_focal_center

@overload
def fov_to_focal(fov: numpy_.ndarray):
    utils3d_moge.numpy.transforms.fov_to_focal

@overload
def focal_to_fov(focal: numpy_.ndarray):
    utils3d_moge.numpy.transforms.focal_to_fov

@overload
def intrinsics_to_fov(intrinsics: numpy_.ndarray) -> Tuple[numpy_.ndarray, numpy_.ndarray]:
    utils3d_moge.numpy.transforms.intrinsics_to_fov
...
## Returns
    ...
    utils3d_moge.numpy.transforms.view_look_at
...
## Returns
    ...
    utils3d_moge.numpy.transforms.extrinsics_look_at
...
## Returns
    ...
    utils3d_moge.numpy.transforms.perspective_to_intrinsics
...
## Parameters"""
    utils3d_moge.numpy.transforms.perspective_to_near_far
...
## Returns
    ...
    utils3d_moge.numpy.transforms.intrinsics_to_perspective
...
## Returns
    ...
    utils3d_moge.numpy.transforms.extrinsics_to_view
...
## Returns
    ...
    utils3d_moge.numpy.transforms.view_to_extrinsics
...
## Returns
    ...
    utils3d_moge.numpy.transforms.normalize_intrinsics
...
## Returns
    ...
    utils3d_moge.numpy.transforms.denormalize_intrinsics
...
## Returns
    ...
    utils3d_moge.numpy.transforms.crop_intrinsics
...
## Returns
    ...
    utils3d_moge.numpy.transforms.pixel_to_uv
...
## Returns
    ...
    utils3d_moge.numpy.transforms.pixel_to_ndc
...
## Returns
    ...
    utils3d_moge.numpy.transforms.uv_to_pixel
...
## Returns
    ...
    utils3d_moge.numpy.transforms.depth_linear_to_buffer
...
## Returns
    ...
    utils3d_moge.numpy.transforms.depth_buffer_to_linear
...
## Returns
    ...
    utils3d_moge.numpy.transforms.unproject_cv
...
## Returns
    points (ndarray): (..., N, 3) 3d points"""
    utils3d_moge.numpy.transforms.unproject_gl
...
## Returns
    ...
    utils3d_moge.numpy.transforms.project_cv
...
## Returns
    scr_coord (ndarray): [..., N, 2] OpenGL screen space XY coordinates, value ranging in [0, 1].
        The origin (0., 0.) is corresponding to the left & bottom
    linear_depth (ndarray): [..., N] linear depth"""
    utils3d_moge.numpy.transforms.project_gl
...
- `depth`: (..., N) linear depth values, where `depth > 0` is visible.
    ...
    utils3d_moge.numpy.transforms.project
...
- `points`: (..., N, 3) 3D world-space points"""
    utils3d_moge.numpy.transforms.unproject
...
## Returns
    ...
    utils3d_moge.numpy.transforms.screen_coord_to_view_coord
...
## Returns
    ...
    utils3d_moge.numpy.transforms.quaternion_to_matrix
...
----
    ...
    utils3d_moge.numpy.transforms.quaternion_multiply
...
----
    ndarray: shape (..., 4)"""
    utils3d_moge.numpy.transforms.quaternion_inverse
...
----
    ...
    utils3d_moge.numpy.transforms.quaternion_normalize
...
## Returns
    ...
    utils3d_moge.numpy.transforms.axis_angle_to_matrix
...
## Returns
    ...
    utils3d_moge.numpy.transforms.matrix_to_quaternion
...
## Returns
    ...
    utils3d_moge.numpy.transforms.extrinsics_to_essential
...
## Returns
    ...
    utils3d_moge.numpy.transforms.axis_angle_to_quaternion
...
## Returns
    ...
    utils3d_moge.numpy.transforms.euler_axis_angle_rotation
...
## Returns
    Rotation matrices as ndarray of shape (..., 3, 3)."""
    utils3d_moge.numpy.transforms.euler_angles_to_matrix
...
## Returns
    ...
    utils3d_moge.numpy.transforms.matrix_to_axis_angle
...
## Returns
    ...
    utils3d_moge.numpy.transforms.matrix_to_euler_angles
...
## Returns
    ...
    utils3d_moge.numpy.transforms.quaternion_to_axis_angle

@overload
def skew_symmetric(v: numpy_.ndarray):
    """Skew symmetric matrix from a 3D vector"""
    utils3d_moge.numpy.transforms.skew_symmetric

@overload
def rotation_matrix_from_vectors(v1: numpy_.ndarray, v2: numpy_.ndarray):
    """Rotation matrix that rotates v1 to v2"""
    utils3d_moge.numpy.transforms.rotation_matrix_from_vectors
...
## Returns
    ...
    utils3d_moge.numpy.transforms.ray_intersection
...
## Returns
    ...
    utils3d_moge.numpy.transforms.make_affine_matrix
...
## Returns
    ...
    utils3d_moge.numpy.transforms.random_rotation_matrix
...
## Returns
    ...
    utils3d_moge.numpy.transforms.lerp
...
## Returns
    ...
    utils3d_moge.numpy.transforms.slerp
...
## Returns
    ...
    utils3d_moge.numpy.transforms.slerp_rotation_matrix
...
## Returns
    ...
    utils3d_moge.numpy.transforms.interpolate_se3_matrix
...
- `y`: ndarray, shape (..., m, d): the interpolated values."""
    utils3d_moge.numpy.transforms.piecewise_lerp
...
- `T_interp`: ndarray, shape (..., m, 4, 4): the interpolated SE(3) matrices."""
    utils3d_moge.numpy.transforms.piecewise_interpolate_se3_matrix
...
- Chain multiple transformations
    ...
    ```"""
    utils3d_moge.numpy.transforms.transform_points
...
`angle`: ndarray, shape (...): the angle between the two vectors."""
    utils3d_moge.numpy.transforms.angle_between

@overload
def kabsch(cov: numpy_.ndarray) -> numpy_.ndarray:
    utils3d_moge.numpy.pose.kabsch
...
- `t`: (..., 3) translation vector. None if mean_x or mean_y is None."""
    utils3d_moge.numpy.pose.umeyama
...
- `t`: (..., 3) translation vector."""
    utils3d_moge.numpy.pose.affine_umeyama
...
- `pose`: (..., 4, 4) transformations matrix from p to q."""
    utils3d_moge.numpy.pose.solve_pose
...
- `inliers`: (..., N) boolean mask of inliers w.r.t. the returned pose."""
    utils3d_moge.numpy.pose.solve_pose_ransac
...
- `pose`: (S, 4, 4) transformations matrix from p to q."""
    utils3d_moge.numpy.pose.segment_solve_pose
...
valid = np.concatenate(valid, axis=0)   # (T_all,), poses' validity over all frames"""
    utils3d_moge.numpy.pose.solve_poses_sequential
...
- `accum`: per point accumulated statistics. Just pass it to the next call for incremental solving.
    ...
    - `accum_wxx`: (N, 3, 3) sum of weights * outer(x - mean_wx, x - mean_wx)
    - `accum_nnz`: (N,) number of non-zero weight accumulations"""
    utils3d_moge.numpy.pose.segment_solve_poses_sequential
...
- `data`: (ndarray) the rolled data, same shape as input."""
    utils3d_moge.numpy.segment_ops.segment_roll
...
- `new_offsets`: (ndarray) shape `(K + 1,)` the offsets of the new segmented data. `K` is the number of taken segments."""
    utils3d_moge.numpy.segment_ops.segment_take
...
If there are multiple maximum values in a segment, the index of the first one is returned. If a segment is empty, -1 is returned."""
    utils3d_moge.numpy.segment_ops.segment_argmax
...
If there are multiple minimum values in a segment, the index of the first one is returned. If a segment is empty, -1 is returned."""
    utils3d_moge.numpy.segment_ops.segment_argmin
...
- `offsets`: (ndarray) shape `(M + 1,)` the offsets of the concatenated segmented data."""
    utils3d_moge.numpy.segment_ops.segment_concatenate
...
- `offsets`: (ndarray) shape `(M + 1,)` the offsets of the concatenated segmented data."""
    utils3d_moge.numpy.segment_ops.segment_concat
...
- `offsets`: (ndarray) shape `(sum(M_i) + 1,)` the offsets of the concatenated segmented data."""
    utils3d_moge.numpy.segment_ops.segment_chain
...
`rearranged_data[offsets[i]:offsets[i + 1]]` corresponding to the i-th segment whose label is `segment_labels[i]`"""
    utils3d_moge.numpy.segment_ops.group_as_segments
...
## Returns
    ...
    utils3d_moge.numpy.mesh.triangulate_mesh
...
- `angles` (ndarray): `(..., F, P)` face corner angles"""
    utils3d_moge.numpy.mesh.compute_face_corner_angles
...
- `normals` (ndarray): (..., F, P, 3) face corner normals"""
    utils3d_moge.numpy.mesh.compute_face_corner_normals
...
- `tangents` (ndarray): `(..., F, P, 3, 2)` face corner tangents (and bitangents),
    ...
    utils3d_moge.numpy.mesh.compute_face_corner_tangents
...
- `normals` (ndarray): `(..., F, 3)` face normals. Always normalized."""
    utils3d_moge.numpy.mesh.compute_face_normals
...
- `tangents` (ndarray): `(..., F, 3, 2)` face corner tangents (and bitangents),
    where the last dimension represents the tangent and bitangent vectors."""
    utils3d_moge.numpy.mesh.compute_face_tangents
...
## Returns
    ...
    utils3d_moge.numpy.mesh.compute_vertex_normals
...
## Returns
    ...
    utils3d_moge.numpy.mesh.remove_corrupted_faces
...
## Returns
    ...
    faces (ndarray): [T, 3] triangular face indices"""
    utils3d_moge.numpy.mesh.merge_duplicate_vertices
...
## Returns
    ...
    *vertice_attrs: vertex attributes
    ...
    utils3d_moge.numpy.mesh.remove_unused_vertices
...
## Returns
    ...
    utils3d_moge.numpy.mesh.subdivide_mesh
...
- `counts` (ndarray): `(E,)` counts of each edge"""
    utils3d_moge.numpy.mesh.mesh_edges
...
NOTE: If the mesh is not manifold, `twin`, `next`, and `prev` can point to arbitrary one of the candidates."""
    utils3d_moge.numpy.mesh.mesh_half_edges
...
- `labels` (ndarray): (N,) int32 component labels corresponding to `vertices_ids`"""
    utils3d_moge.numpy.mesh.mesh_connected_components
...
- `vertices_ids` (ndarray): (N,) vertex indices that are in the edges
- `labels` (ndarray): (N,) int32 component labels corresponding to `vertices_ids`"""
    utils3d_moge.numpy.mesh.graph_connected_components
...
- `graph` (csr_array): adjacency graph in csr format"""
    utils3d_moge.numpy.mesh.mesh_adjacency_graph

@overload
def flatten_mesh_indices(*args: numpy_.ndarray) -> Tuple[numpy_.ndarray, ...]:
    utils3d_moge.numpy.mesh.flatten_mesh_indices
...
### Returns
    ...
    utils3d_moge.numpy.mesh.create_cube_mesh

@overload
def create_icosahedron_mesh():
    """Create an icosahedron mesh of centered at origin."""
    utils3d_moge.numpy.mesh.create_icosahedron_mesh
...
## Returns
    ...
    utils3d_moge.numpy.mesh.create_square_mesh
...
def create_camera_frustum_mesh(extrinsics: numpy_.ndarray, intrinsics: numpy_.ndarray, depth: float = 1.0) -> Tuple[numpy_.ndarray, numpy_.ndarray, numpy_.ndarray]:
    ...
    utils3d_moge.numpy.mesh.create_camera_frustum_mesh
...
## Returns
    ...
    utils3d_moge.numpy.mesh.merge_meshes
...
[[[0.05, 0.05], [0.15, 0.05], ..., [0.95, 0.05]],
 ...
 [[0.05, 0.95], [0.15, 0.95], ..., [0.95, 0.95]]]"""
    utils3d_moge.numpy.maps.uv_map
...
[[0.5, 9.5], [1.5, 9.5], ..., [9.5, 9.5]]]"""
    utils3d_moge.numpy.maps.pixel_coord_map
...
## Returns
    (ndarray): shape (height, width, 2)"""
    utils3d_moge.numpy.maps.screen_coord_map
...
----
    ...
    - If shared_vertices is `False`, each face has its own 4 vertices.
        ...
        ```"""
    utils3d_moge.numpy.maps.build_grid_mesh
...
## Returns
    ...
    *attributes (ndarray): vertex or face attributes in corresponding order with input maps"""
    utils3d_moge.numpy.maps.build_mesh_from_map
...
## Returns
    ...
    *attributes (ndarray): [N, C] vertex attributes or [T, C] face attributes"""
    utils3d_moge.numpy.maps.build_mesh_from_depth_map
...
## Returns
    ...
    utils3d_moge.numpy.maps.depth_map_edge
...
## Returns
    edge (ndarray): shape (..., height, width) of dtype torch.bool"""
    utils3d_moge.numpy.maps.depth_map_aliasing
...
## Returns
    edge (ndarray): shape (..., height, width) of dtype torch.bool"""
    utils3d_moge.numpy.maps.normal_map_edge
...
## Returns
    normal (ndarray): shape (height, width, 3), normal map. """
    utils3d_moge.numpy.maps.point_map_to_normal_map
...
## Returns
    points (ndarray): [..., N, 3] 3d points"""
    utils3d_moge.numpy.maps.depth_map_to_point_map
...
## Returns
    normal (ndarray): shape (height, width, 3), normal map. """
    utils3d_moge.numpy.maps.depth_map_to_normal_map
...
## Returns
    ...
    utils3d_moge.numpy.maps.chessboard
...
- `nearest_indices`: tuple of shape `(..., H', W')`. The nearest neighbor indices of the resized map of each dimension."""
    utils3d_moge.numpy.maps.masked_nearest_resize
...
- `*resized_image`: resized image(s) of shape `(..., H', W', C)`. or `(..., H', W')`
- `resized_mask`: mask of the resized map of shape `(..., H', W')`"""
    utils3d_moge.numpy.maps.masked_area_resize
...
## Returns
    ...
    utils3d_moge.numpy.maps.colorize_depth_map
...
## Returns
    ...
    utils3d_moge.numpy.maps.colorize_normal_map
...
----
- `colored` (ndarray): shape (..., H, W, 3), dtype=uint8, RGB in [0, 255]"""
    utils3d_moge.numpy.maps.colorize_segmentation_map
...
| `alpha=0.5, beta=0.5` | Hourglass-like (inverse-S) | Increase contrast near both extremes globally |"""
    utils3d_moge.numpy.maps.colorize_probability_map
...
- `filled_indices` (Tuple[ndarray, ...], optional): tuple of shape (..., height, width). The nearest neighbor indices of each pixel in the original map.
    ...
    utils3d_moge.numpy.maps.flood_fill
...
- `y` (ndarray): shape (*batch_shape, N_1, ..., N_D), Perlin noise value at the given coordinates and seed. Value range is approximately [-1, 1]"""
    utils3d_moge.numpy.maps.perlin_noise
...
- `noise_map` (ndarray): shape (..., H, W), Perlin noise map. Value range is approximately [-1, 1]"""
    utils3d_moge.numpy.maps.perlin_noise_map
...
- `interpolation_id` (ndarray): (H, W) int32 triangle ID map
- `interpolation_uv` (ndarray): (H, W, 2) float32 triangle UV (first two channels of barycentric coordinates)"""
    utils3d_moge.numpy.rasterization.rasterize_lines
...
- `point_id` (ndarray): (H, W) int32 point ID map"""
    utils3d_moge.numpy.rasterization.rasterize_point_cloud

@overload
def sample_texture(uv_map: numpy_.ndarray, texture_map: numpy_.ndarray, interpolation: Literal['linear', 'nearest'] = 'linear', mipmap_level: Union[int, Tuple[int, int]] = 0, repeat: Union[bool, Tuple[bool, bool]] = False, anisotropic: float = 1.0, ctx: Optional[utils3d_moge.numpy.rasterization.RastContext] = None) -> numpy_.ndarray:
    """Sample from a texture map with a UV map."""
    utils3d_moge.numpy.rasterization.sample_texture

@overload
def test_rasterization(ctx: Optional[utils3d_moge.numpy.rasterization.RastContext] = None):
    """Test if rasterization works. It will render a cube with random colors and save it as a CHECKME.png file."""
    utils3d_moge.numpy.rasterization.test_rasterization
...
## Returns
    ...
    utils3d_moge.numpy.io.colmap.read_extrinsics_from_colmap
...
## Returns
    ...
    utils3d_moge.numpy.io.colmap.read_intrinsics_from_colmap
...
## Parameters
    ...
    utils3d_moge.numpy.io.colmap.write_extrinsics_as_colmap
...
## Parameters
    ...
    utils3d_moge.numpy.io.colmap.write_intrinsics_as_colmap

@overload
def read_obj(file: Union[str, pathlib._local.Path, _io.TextIOWrapper], encoding: Optional[str] = None, ignore_unknown: bool = False) -> utils3d_moge.numpy.io.obj.WavefrontOBJDict:
...
- `mtllib` (List[str]): list of material library filenames - `mtllib` lines in .obj file."""
    utils3d_moge.numpy.io.obj.read_obj

@overload
def write_obj(file: Union[str, pathlib._local.Path, os.PathLike], obj: utils3d_moge.numpy.io.obj.WavefrontOBJDict, encoding: Optional[str] = None):
    utils3d_moge.numpy.io.obj.write_obj
...
| Content Type   |  `utils3d_moge` | `Open3D` | `Trimesh` | `plyfile` | `meshio` |
|-----------  |------------| -------- |-----------|-----------| ---------|
...
| Polygon Mesh (V=437,645, F=871,414) | 289.5 ms | x | x | 1999.5 ms | 3905.3 ms |"""
    utils3d_moge.numpy.io.ply.read_ply
...
| Polygon Mesh (V=437,645, F=871,414) | 234.0 ms | x | x | 1653.2 ms | 12360.8 ms |"""
    utils3d_moge.numpy.io.ply.write_ply
...
- (Tensor): Sliding window of the input array.
    - If no padding, the output is a view of the input array with zero copy.
    - Otherwise, the output is no longer a view but a copy of the padded array."""
    utils3d_moge.torch.utils.sliding_window
...
def masked_min(input: torch_.Tensor, mask: torch_.BoolTensor, dim: int = None, keepdim: bool = False) -> Union[torch_.Tensor, Tuple[torch_.Tensor, torch_.Tensor]]:
    ...
    """
    utils3d_moge.torch.utils.masked_min
...
def masked_max(input: torch_.Tensor, mask: torch_.BoolTensor, dim: int = None, keepdim: bool = False) -> Union[torch_.Tensor, Tuple[torch_.Tensor, torch_.Tensor]]:
    ...
    """
    utils3d_moge.torch.utils.masked_max
...
- If using triton implementation (based on hashmap), the average complexity `O(Q + K)`. Much faster for large `Q` and `K`."""
    utils3d_moge.torch.utils.lookup
...
## Returns
    ...
    utils3d_moge.torch.utils.lookup_get
...
- `result_value (Tensor): shape `(N_new, *value_shape)` """
    utils3d_moge.torch.utils.lookup_set
...
## Returns
    Tensor: shape `(N, n_cols)` sparse CSR adjacency matrix"""
    utils3d_moge.torch.utils.csr_matrix_from_dense_indices

@overload
def csr_eliminate_zeros(input: torch_.Tensor):
    """Remove zero elements from a sparse CSR tensor.
    """
    utils3d_moge.torch.utils.csr_eliminate_zeros
...
- `groups` (List[Tuple[Tensor, Tensor]]): List of each group, a tuple of `(label, data_in_group)`.
    ...
    If `data` is None, `data_in_group` will be the indices of the data points in the original array."""
    utils3d_moge.torch.utils.group
...
Sorting is always stable."""
    utils3d_moge.torch.utils.lexsort
...
- (Tensor) the modified tensor after putting the values."""
    utils3d_moge.torch.utils.index_reduce
...
----
- (Tensor) the modified tensor after putting the values."""
    utils3d_moge.torch.utils.index_reduce_
...
- If none of src was scattered to a position (i.e., not presented, or the min value is from the original input), the index will be -1."""
    utils3d_moge.torch.utils.scatter_argmax
...
- If multiple values in `src` are equal to the min value at a position, the one with the smallest index in `src` will be chosen.
- If none of src was scattered to a position (i.e., not presented, or the min value is from the original input), the index will be -1."""
    utils3d_moge.torch.utils.scatter_argmin
...
- `outer` (Tensor): shape `(..., M, N)` outer product of `x` and `y`."""
    utils3d_moge.torch.utils.vector_outer
...
## Returns
    ...
    utils3d_moge.torch.transforms.perspective_from_fov
...
## Returns
    (Tensor): [..., 4, 4] perspective matrix"""
    utils3d_moge.torch.transforms.perspective_from_window
...
----
    ...
    utils3d_moge.torch.transforms.intrinsics_from_fov
...
## Returns
    (Tensor): [..., 3, 3] OpenCV intrinsics matrix"""
    utils3d_moge.torch.transforms.intrinsics_from_focal_center

@overload
def focal_to_fov(focal: torch_.Tensor):
    utils3d_moge.torch.transforms.focal_to_fov

@overload
def fov_to_focal(fov: torch_.Tensor):
    utils3d_moge.torch.transforms.fov_to_focal
...
def intrinsics_to_fov(intrinsics: torch_.Tensor) -> Tuple[torch_.Tensor, torch_.Tensor]:
    ...
    utils3d_moge.torch.transforms.intrinsics_to_fov
...
## Returns
    ...
    utils3d_moge.torch.transforms.view_look_at
...
## Returns
    ...
    utils3d_moge.torch.transforms.extrinsics_look_at
...
## Returns
    ...
    utils3d_moge.torch.transforms.perspective_to_intrinsics
...
## Returns
    ...
    utils3d_moge.torch.transforms.intrinsics_to_perspective
...
## Returns
    ...
    utils3d_moge.torch.transforms.extrinsics_to_view
...
## Returns
    ...
    utils3d_moge.torch.transforms.view_to_extrinsics
...
## Returns
    ...
    utils3d_moge.torch.transforms.normalize_intrinsics
...
## Returns
    ...
    utils3d_moge.torch.transforms.denormalize_intrinsics
...
## Returns
    ...
    utils3d_moge.torch.transforms.crop_intrinsics
...
## Returns
    ...
    utils3d_moge.torch.transforms.pixel_to_uv
...
## Returns
    ...
    utils3d_moge.torch.transforms.pixel_to_ndc
...
## Returns
    ...
    utils3d_moge.torch.transforms.uv_to_pixel
...
## Returns
    ...
    utils3d_moge.torch.transforms.depth_linear_to_buffer
...
## Returns
    (Tensor): [...] linear depth"""
    utils3d_moge.torch.transforms.depth_buffer_to_linear
...
## Returns
    ...
    utils3d_moge.torch.transforms.project_gl
...
## Returns
    uv_coord (Tensor): [..., N, 2] uv coordinates, value ranging in [0, 1].
        The origin (0., 0.) is corresponding to the left & top
    linear_depth (Tensor): [..., N] linear depth"""
    utils3d_moge.torch.transforms.project_cv
...
## Returns
    points (Tensor): (..., N, 3) 3d points"""
    utils3d_moge.torch.transforms.unproject_gl
...
## Returns
    points (Tensor): [..., N, 3] 3d points"""
    utils3d_moge.torch.transforms.unproject_cv
...
- `depth`: (..., N) linear depth values, where `depth > 0` is visible.
    - For OpenCV convention, it is the Z coordinate in camera space.
    - For OpenGL convention, it is the -Z coordinate in camera space."""
    utils3d_moge.torch.transforms.project
...
- `points`: (..., N, 3) 3D world-space points"""
    utils3d_moge.torch.transforms.unproject

@overload
def skew_symmetric(v: torch_.Tensor):
    """Skew symmetric matrix from a 3D vector"""
    utils3d_moge.torch.transforms.skew_symmetric

@overload
def rotation_matrix_from_vectors(v1: torch_.Tensor, v2: torch_.Tensor):
    """Rotation matrix that rotates v1 to v2"""
    utils3d_moge.torch.transforms.rotation_matrix_from_vectors
...
## Returns
    ...
    utils3d_moge.torch.transforms.euler_axis_angle_rotation
...
## Returns
    Rotation matrices as tensor of shape (..., 3, 3)."""
    utils3d_moge.torch.transforms.euler_angles_to_matrix
...
## Returns
    ...
    utils3d_moge.torch.transforms.matrix_to_euler_angles
...
## Returns
    ...
    utils3d_moge.torch.transforms.matrix_to_quaternion
...
## Returns
    ...
    utils3d_moge.torch.transforms.quaternion_to_matrix
...
----
    ...
    utils3d_moge.torch.transforms.quaternion_multiply
...
----
    ...
    utils3d_moge.torch.transforms.quaternion_inverse
...
----
    ...
    utils3d_moge.torch.transforms.quaternion_normalize
...
## Returns
    ...
    utils3d_moge.torch.transforms.matrix_to_axis_angle
...
## Returns
    ...
    utils3d_moge.torch.transforms.axis_angle_to_matrix
...
## Returns
    ...
    utils3d_moge.torch.transforms.axis_angle_to_quaternion
...
## Returns
    ...
    utils3d_moge.torch.transforms.quaternion_to_axis_angle
...
## Returns
    ...
    utils3d_moge.torch.transforms.make_affine_matrix
...
## Returns
    ...
    utils3d_moge.torch.transforms.random_rotation_matrix
...
## Returns
    ...
    utils3d_moge.torch.transforms.lerp
...
## Returns
    ...
    utils3d_moge.torch.transforms.slerp
...
## Returns
    ...
    utils3d_moge.torch.transforms.slerp_rotation_matrix
...
## Returns
    ...
    utils3d_moge.torch.transforms.interpolate_se3_matrix
...
## Returns
    ...
    utils3d_moge.torch.transforms.extrinsics_to_essential
...
## Returns
    ...
    utils3d_moge.torch.transforms.rotation_matrix_2d
...
## Returns
    ...
    utils3d_moge.torch.transforms.rotate_2d
...
## Returns
    (Tensor): (..., 3, 3) transformation matrix"""
    utils3d_moge.torch.transforms.translate_2d
...
## Returns
    (Tensor): (..., 3, 3) transformation matrix"""
    utils3d_moge.torch.transforms.scale_2d
...
- Chain multiple transformations
    ...
    y = transform(x_3, T1_4x4, T2_3x4, T3_3x4)
    ```"""
    utils3d_moge.torch.transforms.transform_points
...
`angle`: Tensor, shape (...): the angle between the two vectors."""
    utils3d_moge.torch.transforms.angle_between
...
def kabsch(cov: torch_.Tensor, eps: float = 1e-12):
    ...
    """
    utils3d_moge.torch.pose.kabsch
...
- `R`: (..., 3, 3) rotation matrix.
- `t`: (..., 3) translation vector. None if mean_x or mean_y is None."""
    utils3d_moge.torch.pose.umeyama
...
- `A`: (..., 3, 3) affine transformation matrix.
- `t`: (..., 3) translation vector."""
    utils3d_moge.torch.pose.affine_umeyama
...
----
- `pose`: (..., 4, 4) transformations matrix from p to q."""
    utils3d_moge.torch.pose.solve_pose
...
- `pose`: (..., 4, 4) transformations matrix from p to q.
- `inliers`: (..., N) boolean mask of inliers w.r.t. the returned pose."""
    utils3d_moge.torch.pose.solve_pose_ransac
...
----
- `pose`: (S, 4, 4) transformations matrix from p to q."""
    utils3d_moge.torch.pose.segment_solve_pose
...
- `accum`: per-point accumulated statistics. Pass it to the next call for incremental solving."""
    utils3d_moge.torch.pose.solve_poses_sequential
...
- `accum`: per-point accumulated statistics for incremental solving."""
    utils3d_moge.torch.pose.segment_solve_poses_sequential
...
- `w`: (...,) total correspondence weight per edge (the per-edge sum of the input `w`; translation
    information)."""
    utils3d_moge.torch.pose.pose_graph_edge_moments
...
- `w`: (E,) total correspondence weight per edge (the per-edge sum of the input `w`; translation
    information)."""
    utils3d_moge.torch.pose.segment_pose_graph_edge_moments
...
- `poses_global`: (N, 4, 4) global poses (world-to-node) for each node. The linear part is `R_i`
    ...
    utils3d_moge.torch.pose.pose_graph_optimization
...
- `weights`: (E,) GNC inlier weights in `[0, 1]` (independent of the input `edge_weights`). 1 marks a
    ...
    utils3d_moge.torch.pose.pose_graph_optimization_gnc
...
- `data`: (Tensor) the rolled data, same shape as input."""
    utils3d_moge.torch.segment_ops.segment_roll
...
- `new_offsets`: (Tensor) shape `(K + 1,)` the offsets of the new segmented data. `K` is the number of taken segments."""
    utils3d_moge.torch.segment_ops.segment_take
...
- `offsets`: (Tensor) shape `(M + 1,)` the offsets of the concatenated segmented data."""
    utils3d_moge.torch.segment_ops.segment_concatenate
...
- `offsets`: (Tensor) shape `(M + 1,)` the offsets of the concatenated segmented data."""
    utils3d_moge.torch.segment_ops.segment_concat
...
- `offsets`: (Tensor) shape `(sum(M_i) + 1,)` the offsets of the concatenated segmented data."""
    utils3d_moge.torch.segment_ops.segment_chain
...
NOTE: If there are multiple maximum values in a segment, the index of the first one is returned. If a segment is empty, -1 is returned."""
    utils3d_moge.torch.segment_ops.segment_argmax
...
NOTE: If there are multiple minimum values in a segment, the index of the first one is returned. If a segment is empty, -1 is returned."""
    utils3d_moge.torch.segment_ops.segment_argmin
...
- If a segment is empty or has negative length, the median value is undefined."""
    utils3d_moge.torch.segment_ops.segment_median
...
- `segment_sums`: (Tensor) shape `(..., M, ...)` the sum of each segment along the specified dimension."""
    utils3d_moge.torch.segment_ops.segment_sum
...
- `segment_sums`: (Tensor) shape `(..., N, ...)` the cumulative sum of each segment along the specified dimension."""
    utils3d_moge.torch.segment_ops.segment_cumsum
...
- `group_ids` (Tensor, optional): shape `(N,)`. The group id for each data point in the original order,
    ...
    utils3d_moge.torch.segment_ops.group_as_segments
...
- `indices`: (Tensor) shape `(..., N, ...)` the indices that would sort the data within each segment."""
    utils3d_moge.torch.segment_ops.segment_sort
...
- `sorted_indices`: (Tensor) shape `(..., N, ...)` the indices that would sort the data within each segment."""
    utils3d_moge.torch.segment_ops.segment_argsort
...
- If the length of a segment is less than k, the returns will contain all elements in that segment but fewer than k elements."""
    utils3d_moge.torch.segment_ops.segment_topk
...
- `indices`: (Tensor) shape `(..., M, max_length)` the indices of the stacked entries in the original input."""
    utils3d_moge.torch.segment_ops.stack_segments
...
- `offsets`: (LongTensor) shape `(M + 1,)` the offsets of the sampled indices for each segment."""
    utils3d_moge.torch.segment_ops.segment_multinomial
...
- The result may contain zero-length segments if a segment has less than `r` elements."""
    utils3d_moge.torch.segment_ops.segment_combinations
...
- `indices: Tensor` of shape (..., Q), the insertion indices for each value in `input` within its corresponding segment in `sorted_sequence`."""
    utils3d_moge.torch.segment_ops.segment_searchsorted
...
## Returns
    ...
    utils3d_moge.torch.mesh.triangulate_mesh
...
- `angles` (Tensor): `(..., F, P)` face corner angles"""
    utils3d_moge.torch.mesh.compute_face_corner_angles
...
- `normals` (Tensor): (..., F, P, 3) face corner normals"""
    utils3d_moge.torch.mesh.compute_face_corner_normals
...
s
    ...
    - `tangents` (Tensor): `(..., F, P, 3, 2)` face corner tangents (and bitangents),
        where the last dimension represents the tangent and bitangent vectors.
    """
    utils3d_moge.torch.mesh.compute_face_corner_tangents
...
- `normals` (Tensor): `(..., F, 3)` face normals. Always normalized."""
    utils3d_moge.torch.mesh.compute_face_normals
...
- `tangents` (Tensor): `(..., F, 3, 2)` face corner tangents (and bitangents),
    where the last dimension represents the tangent and bitangent vectors."""
    utils3d_moge.torch.mesh.compute_face_tangents
...
- `counts` (Tensor): `(E,)` counts of each edge"""
    utils3d_moge.torch.mesh.mesh_edges
...
NOTE: If the mesh is not manifold, `twin`, `next`, and `prev` can point to arbitrary one of the candidates."""
    utils3d_moge.torch.mesh.mesh_half_edges
...
- `dual_graph` (Tensor): `(F, F)` binary sparse CSR matrix. Adjacency matrix of the dual graph."""
    utils3d_moge.torch.mesh.mesh_dual_graph
...
- `labels` (Tensor): (N,) component labels corresponding to `vertices_ids`"""
    utils3d_moge.torch.mesh.mesh_connected_components
...
- `vertices_ids` (Tensor): (N,) vertex indices that are in the edges
- `labels` (Tensor): (N,) component labels corresponding to `vertices_ids`"""
    utils3d_moge.torch.mesh.graph_connected_components
...
## Returns
    ...
    utils3d_moge.torch.mesh.compute_boundaries
...
## Returns
    ...
    *vertice_attrs: vertex attributes
    ...
    utils3d_moge.torch.mesh.remove_unused_vertices
...
## Returns
    ...
    utils3d_moge.torch.mesh.remove_corrupted_faces
...
## Returns
    ...
    faces (Tensor): [T, 3] triangular face indices"""
    utils3d_moge.torch.mesh.remove_isolated_pieces
...
## Returns
    vertices (Tensor): [N_, 3] 3-dimensional vertices
    faces (Tensor): [T, 3] triangular face indices"""
    utils3d_moge.torch.mesh.merge_duplicate_vertices
...
## Returns
    ...
    utils3d_moge.torch.mesh.subdivide_mesh
...
## Parameters
    ...
    utils3d_moge.torch.mesh.compute_mesh_laplacian
...
## Parameters
    ...
    faces (Tensor): shape (T, 3)
    weight (str): 'uniform' or 'cotangent'"""
    utils3d_moge.torch.mesh.laplacian_smooth_mesh
...
## Returns
    ...
    utils3d_moge.torch.mesh.taubin_smooth_mesh
...
def laplacian_hc_smooth_mesh(vertices: torch_.Tensor, faces: torch_.Tensor, times: int = 5, alpha: float = 0.5, beta: float = 0.5, weight: str = 'uniform'):
    ...
    """
    utils3d_moge.torch.mesh.laplacian_hc_smooth_mesh
...
### Returns
    ...
    utils3d_moge.torch.mesh.create_cube_mesh
...
def create_camera_frustum_mesh(extrinsics: torch_.Tensor, intrinsics: torch_.Tensor, depth: float = 1.0) -> Tuple[torch_.Tensor, torch_.Tensor, torch_.Tensor]:
    """Create a triangle mesh of camera frustum."""
    utils3d_moge.torch.mesh.create_camera_frustum_mesh

@overload
def create_icosahedron_mesh(device: Optional[torch_.device] = None) -> Tuple[torch_.Tensor, torch_.Tensor]:
    """Create an icosahedron mesh of centered at origin."""
    utils3d_moge.torch.mesh.create_icosahedron_mesh
...
[[[0.05, 0.05], [0.15, 0.05], ..., [0.95, 0.05]],
 [[0.05, 0.15], [0.15, 0.15], ..., [0.95, 0.15]],
  ...             ...                  ...
 [[0.05, 0.95], [0.15, 0.95], ..., [0.95, 0.95]]]"""
    utils3d_moge.torch.maps.uv_map
...
[[[0.5, 0.5], [1.5, 0.5], ..., [9.5, 0.5]],
 [[0.5, 1.5], [1.5, 1.5], ..., [9.5, 1.5]],
  ...             ...                  ...
[[0.5, 9.5], [1.5, 9.5], ..., [9.5, 9.5]]]"""
    utils3d_moge.torch.maps.pixel_coord_map
...
## Returns
    (Tensor): shape (height, width, 2)"""
    utils3d_moge.torch.maps.screen_coord_map
...
## Returns
    ...
    *attributes (Tensor): vertex attributes in corresponding order with itorchut maps
    ...
    utils3d_moge.torch.maps.build_mesh_from_map
...
## Returns
    ...
    *other_attrs (Tensor): [N, C] vertex attributes"""
    utils3d_moge.torch.maps.build_mesh_from_depth_map
...
## Returns
    ...
    utils3d_moge.torch.maps.depth_map_edge
...
## Returns
    edge (Tensor): shape (..., height, width) of dtype torch.bool"""
    utils3d_moge.torch.maps.depth_map_aliasing
...
## Returns
    normal (Tensor): shape (..., height, width, 3), normal map. """
    utils3d_moge.torch.maps.depth_map_to_normal_map
...
- `image` (Tensor): shape (height, width, channels), chessboard image"""
    utils3d_moge.torch.maps.chessboard
...
## Returns
    ...
    utils3d_moge.torch.maps.bounding_rect_from_mask
...
- `resized_mask`: mask of the resized map of shape `(..., H', W')`
- `nearest_indices`: tuple of shape `(..., H', W')`. The nearest neighbor indices of the resized map of each dimension."""
    utils3d_moge.torch.maps.masked_nearest_resize
...
- `*resized_image`: resized image(s) of shape `(..., H', W', C)`. or `(..., H', W')`
- `resized_mask`: mask of the resized map of shape `(..., H', W')`"""
    utils3d_moge.torch.maps.masked_area_resize
...
- `filled_indices` (Tuple[Tensor, ...], optional): tuple of shape (..., height, width). The nearest neighbor indices of each pixel in the original map.
    It satisfies `filled_image = image[filled_indices]`"""
    utils3d_moge.torch.maps.flood_fill
...
- `y` (Tensor): shape (*batch_shape, N_1, ..., N_D), Perlin noise value at the given coordinates and seed. Value range is approximately [-1, 1]"""
    utils3d_moge.torch.maps.perlin_noise
...
- `noise_map` (Tensor): shape (..., H, W), Perlin noise map. Value range is approximately [-1, 1]"""
    utils3d_moge.torch.maps.perlin_noise_map
...
- `noise_map` (Tensor): shape (..., H, W), fractal Perlin noise map. Value range is approximately [-1, 1]"""
    utils3d_moge.torch.maps.fractal_perlin_noise_map
...
----
    ...
    ctx (RastContext): rasterization context. Defaults to the thread-local default context. If custom context is needed, provide one with utils3d_moge.pt.RastContext().
...
A dictionary containing:
    ...
    utils3d_moge.torch.rasterization.rasterize_triangles
...
for i, layer_output in enumerate(rasterize_triangles_peeling(
    ...
    if i >= 4:  # Stop after 5 layers at most
        break
```"""
    utils3d_moge.torch.rasterization.rasterize_triangles_peeling
...
## Returns
    ...
    utils3d_moge.torch.rasterization.sample_texture
...
## Returns
    ...
    utils3d_moge.torch.rasterization.texture_composite
