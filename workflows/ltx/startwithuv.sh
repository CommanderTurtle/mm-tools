...
export MM_STUDIO_HOST="${LTX_STUDIO_HOST:-${MM_STUDIO_HOST:-127.0.0.1}}"
export MM_STUDIO_PORT="${LTX_STUDIO_PORT:-${MM_STUDIO_PORT:-8269}}"
unset MM_STUDIO_API_ONLY

printf 'LTX-2.5 Story Studio: http://%s:%s\n' "$MM_STUDIO_HOST" "$MM_STUDIO_PORT"
